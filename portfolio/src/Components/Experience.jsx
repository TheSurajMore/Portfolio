...
const Experience = () => {
  ...
  <ListItem>
    ...
    <ListIcon as={CheckCircleIcon} color='green.500' />
    <ListItem>    After almost a year of learning, I make sure I am prepared for the job before looking for it, and I adapted the mindset of a developer to turn any possibility into reality, either with my existing knowledge or learning new abilities.   </ListItem>
  </ListItem>
</List>
</Box>
</Center>
